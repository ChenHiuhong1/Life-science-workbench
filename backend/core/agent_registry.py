...
AGENTS: List[AgentDef] = [
    ...
    AgentDef(
        ...
        base_prompt=(
            ...
            "- The code execution working directory is the artifact collection directory.\n"
            ...
            "sample size and power considerations, random seeds, and reproducibility metadata. Follow the response "
            "language instruction injected by the chat route."
        ),
